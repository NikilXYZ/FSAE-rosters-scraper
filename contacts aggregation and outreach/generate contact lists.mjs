...
let we_know_linkedin = (student) => !!linkedin["linkedin"]
...
fs.writeFileSync("students to email.json", JSON.stringify(students_to_email))
fs.writeFileSync("students to linkedin.json", JSON.stringify(students_to_linkedin))
fs.writeFileSync("linkedin urls.json", JSON.stringify(linkedin_urls))
fs.writeFileSync("people we contact twice.json", JSON.stringify(students_to_email_and_linkedin))
